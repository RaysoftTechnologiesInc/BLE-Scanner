...
const static char DEVICE_NAME[] = "RayGattClient";
...
private:
    ...
    void start_advertising()
    {
        ...
        ble_error_t error = _ble_interface.gap().setAdvertisingParameters(
        ...
        error = _ble_interface.gap().setAdvertisingPayload(
                    ble::LEGACY_ADVERTISING_HANDLE,
        ...
        error = _ble_interface.gap().startAdvertising(ble::LEGACY_ADVERTISING_HANDLE);
