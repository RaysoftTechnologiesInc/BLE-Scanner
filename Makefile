...
OBJECTS += ./BleGap/BleScanner.o
OBJECTS += ./Libraries/esp32-driver/ESP32/ESP32.o
OBJECTS += ./Libraries/esp32-driver/ESP32Interface.o
OBJECTS += ./Libraries/esp32-driver/ESP32InterfaceAP.o
OBJECTS += ./Libraries/esp32-driver/ESP32Stack.o
OBJECTS += ./gattclient.o
OBJECTS += ./main.o
...
OBJECTS += ./mbed-os/components/storage/blockdevice/COMPONENT_I2CEE/I2CEEBlockDevice.o
...
OBJECTS += ./mbed-os/features/FEATURE_BLE/targets/TARGET_ESP32AT_BLE/BleImplementation.o
OBJECTS += ./mbed-os/features/FEATURE_BLE/targets/TARGET_ESP32AT_BLE/Esp32AtBLE.o
OBJECTS += ./mbed-os/features/FEATURE_BLE/targets/TARGET_ESP32AT_BLE/Esp32AtGap.o
OBJECTS += ./mbed-os/features/FEATURE_BLE/targets/TARGET_ESP32AT_BLE/Esp32AtGattClient.o
OBJECTS += ./mbed-os/features/FEATURE_BLE/targets/TARGET_ESP32AT_BLE/Esp32AtGattServer.o
...
OBJECTS += ./mbed-os/targets/TARGET_STM/TARGET_STM32F4/TARGET_STM32F413xH/TARGET_URAPTOR_BASEBOARD/PeripheralPins.o
OBJECTS += ./mbed-os/targets/TARGET_STM/TARGET_STM32F4/TARGET_STM32F413xH/TARGET_URAPTOR_BASEBOARD/system_clock.o
OBJECTS += ./mbed-os/targets/TARGET_STM/TARGET_STM32F4/TARGET_STM32F413xH/device/TOOLCHAIN_GCC_ARM/startup_stm32f413xx.o
...
INCLUDE_PATHS += -I../.
INCLUDE_PATHS += -I.././BLE Utils
INCLUDE_PATHS += -I.././BLE_Tests
INCLUDE_PATHS += -I.././BleGap
INCLUDE_PATHS += -I.././Libraries
INCLUDE_PATHS += -I.././Libraries/esp32-driver
INCLUDE_PATHS += -I.././Libraries/esp32-driver/ESP32
...
INCLUDE_PATHS += -I.././mbed-os/components/storage/blockdevice/COMPONENT_I2CEE
...
INCLUDE_PATHS += -I.././mbed-os/features/FEATURE_BLE/targets/TARGET_ESP32AT_BLE
...
INCLUDE_PATHS += -I.././mbed-os/targets/TARGET_STM/TARGET_STM32F4/TARGET_STM32F413xH
INCLUDE_PATHS += -I.././mbed-os/targets/TARGET_STM/TARGET_STM32F4/TARGET_STM32F413xH/TARGET_URAPTOR_BASEBOARD
INCLUDE_PATHS += -I.././mbed-os/targets/TARGET_STM/TARGET_STM32F4/TARGET_STM32F413xH/device
INCLUDE_PATHS += -I.././mbed-os/targets/TARGET_STM/TARGET_STM32F4/device
INCLUDE_PATHS += -I../F:/Mbed/esp32tests/mbed-os

LIBRARY_PATHS :=
LIBRARIES :=
LINKER_SCRIPT ?= .././mbed-os/targets/TARGET_STM/TARGET_STM32F4/TARGET_STM32F413xH/device/TOOLCHAIN_GCC_ARM/STM32F413xH.ld
...
C_FLAGS += -DTARGET_URAPTOR_BASEBOARD
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1637596035.611422
...
C_FLAGS += -DTARGET_NAME=URAPTOR_BASEBOARD
C_FLAGS += -DDEVICE_SPIF=1
...
C_FLAGS += -DTARGET_STM32F413xH
C_FLAGS += -DDEVICE_SPISLAVE=1
C_FLAGS += -DTARGET_LIKE_MBED
C_FLAGS += -DCOMPONENT_FLASHIAP=1
C_FLAGS += -DCOMPONENT_I2CEE=1
...
CXX_FLAGS += -DTARGET_URAPTOR_BASEBOARD
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1637596035.611422
...
CXX_FLAGS += -DTARGET_NAME=URAPTOR_BASEBOARD
CXX_FLAGS += -DDEVICE_SPIF=1
...
CXX_FLAGS += -DTARGET_STM32F413xH
CXX_FLAGS += -DDEVICE_SPISLAVE=1
CXX_FLAGS += -DTARGET_LIKE_MBED
CXX_FLAGS += -DCOMPONENT_FLASHIAP=1
CXX_FLAGS += -DCOMPONENT_I2CEE=1
...
ASM_FLAGS += -I..
ASM_FLAGS += -I..\BLE Utils
ASM_FLAGS += -I..\BLE_Tests
ASM_FLAGS += -I..\BleGap
ASM_FLAGS += -I..\Libraries
ASM_FLAGS += -I..\Libraries\esp32-driver
ASM_FLAGS += -I..\Libraries\esp32-driver\ESP32
ASM_FLAGS += -I..\mbed-os
...
ASM_FLAGS += -I..\mbed-os\components\storage\blockdevice\COMPONENT_I2CEE
...
ASM_FLAGS += -I..\mbed-os\features\FEATURE_BLE\targets\TARGET_ESP32AT_BLE
...
ASM_FLAGS += -I..\mbed-os\targets\TARGET_STM\TARGET_STM32F4\TARGET_STM32F413xH
ASM_FLAGS += -I..\mbed-os\targets\TARGET_STM\TARGET_STM32F4\TARGET_STM32F413xH\TARGET_URAPTOR_BASEBOARD
ASM_FLAGS += -I..\mbed-os\targets\TARGET_STM\TARGET_STM32F4\TARGET_STM32F413xH\device
ASM_FLAGS += -I..\mbed-os\targets\TARGET_STM\TARGET_STM32F4\device
ASM_FLAGS += -IF:\Mbed\esp32tests\mbed-os
ASM_FLAGS += -include
...
ASM_FLAGS += -fdiagnostics-color
ASM_FLAGS += -fdiagnostics-generate-patch
